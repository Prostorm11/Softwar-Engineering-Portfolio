        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h3 className="text-2xl font-semibold">
              Passionate Mobile App & Frontend Developer
            </h3>

            <p className="text-muted-foreground">
              With over 2 years of experience in mobile app development, I
              specialize in building AI-powered applications that are scalable,
              reliable, and maintainable. I also have a strong foundation in
              machine learning, enabling me to integrate intelligent features
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    Designing intuitive apps with seamless user
                    experiences.
                  </p>
                </div>
              </div>
